...
- **Limpieza de Archivos Temporales:** Luego de realizar pruebas o crear scripts (ej. de Python o Node) para investigar o solucionar problemas, debes eliminar esos archivos generados en cuanto el usuario te lo indique, demos por finalizado un plan de implementación, o hayamos concluido la tarea para evitar dejar basura en el repositorio.