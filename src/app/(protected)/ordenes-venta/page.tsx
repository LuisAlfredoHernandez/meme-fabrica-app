                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm font-medium text-slate-400 mt-2">
                            Gestiona las solicitudes de los clientes y transfiérelas a producción.
                        </p>
                    </div>

                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => fetchOrdenesVenta()}
                            disabled={loading}
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 rounded-xl font-black text-white shadow-lg transition-all hover:shadow-orange-500/20 hover:scale-105 active:scale-95"
